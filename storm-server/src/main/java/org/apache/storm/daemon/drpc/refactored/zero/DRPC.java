...
package org.apache.storm.daemon.drpc.refactored.zero;
...
public class DRPC implements AutoCloseable {
    ...
    @VisibleForTesting
    public static void checkAuthorization(ReqContext reqContext, IAuthorizer auth, String operation, String function)
