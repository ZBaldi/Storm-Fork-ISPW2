...
public class DummyDRPC implements AutoCloseable {
    private static final Logger LOG = LoggerFactory.getLogger(DummyDRPC.class);
    ...
    public DummyDRPC(DummyStormMetricRegistry metricsRegistry, OkDummyIAuthorizer auth, long timeoutMs) {
        this.auth = auth;
    ...
    public DummyDRPC(DummyStormMetricRegistry metricsRegistry, KoDummyIAuthorizer auth, long timeoutMs) {
        this.auth = auth;
        this.meterServerTimedOut = metricsRegistry.registerMeter("drpc:num-server-timedout-requests");
        this.meterExecuteCalls = metricsRegistry.registerMeter("drpc:num-execute-calls");
        this.meterResultCalls = metricsRegistry.registerMeter("drpc:num-result-calls");
